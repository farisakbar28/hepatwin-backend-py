...
- **Cloud Database & Infrastructure:**
  ...
  - *Deployment:* **Vercel** (Frontend) & **Railway / AWS** (Backend Container) dengan sertifikasi SSL/HTTPS penuh.
