...
- **Cloud Database & Infrastructure:**
  ...
  - *Deployment:* **Vercel** (Frontend) & **Koyeb** (Backend Container) dengan sertifikasi SSL/HTTPS penuh.
...
| **Sprint 7** *(Wajib selesai - Syarat Finalis November)* | 1 Minggu | Production Release, System Freeze, Audit Teknis | Deployment produksi (Vercel + Koyeb, SSL/HTTPS penuh), uji penetrasi keamanan sederhana & uji beban API, persiapan audit source code Babak Final **+ PBPK_Engine_Audit_Report_v2_3.md final** | **Rencana (0%)** |
